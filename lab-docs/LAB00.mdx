...
```bash
gh run list -R ELT73A-S22-2026-2/lab00-grupo-a -L 1
```
...
```text
clone   →  gh repo clone ELT73A-S22-2026-2/lab00-grupo-a
status  →  git status
...
Contexto: repo do grupo `ELT73A-S22-2026-2/lab00-grupo-a` (troque a letra).
